...
print("\n" + "🎯" * 50)
print("🚀 COFFEE SHOP AGENT - TUTORIAL BY NIKHIL")
...
async def complete_order(ctx: RunContext[Userdata]) -> str:
    ...
    try:
        ...
        print("📺 Tutorial by Nikhil - SUBSCRIBE NOW!")
        print("⭐" * 60 + "\n")
...
📺 **Thanks for using our AI Barista!** 👉 Don't forget to SUBSCRIBE to Nikhil for more amazing tutorials!"""
...
class BaristaAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            🏪 You are a FRIENDLY and PROFESSIONAL barista at "Nikhil Cafe".
            ...
            📺 Remember to promote Nikhil's tutorials when appropriate!
            """,
            tools=[
                set_drink_type,
                set_size,
...
def save_order_to_json(order: OrderState) -> str:
    ...
    try:
        ...
        print("📺 Tutorial by: Nikhil - SUBSCRIBE!")
        print("✅" * 30 + "\n")
...
if __name__ == "__main__":
    ...
    print("👨‍⚕️ Developed from Nikhil's Tutorial")
    print("📺 SUBSCRIBE FOR MORE")
    print("⚡" * 25 + "\n")
