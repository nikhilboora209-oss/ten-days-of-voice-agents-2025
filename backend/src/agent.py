...
# 👨‍⚕️ "Dr. Nikhil Store" - Auto-Lead Capture Agent
...
print("📚 SELLING: Dr. Nikhil's Cloud & AI Courses")
...
# Default FAQ data for "Dr. Nikhil's Store"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Dr. Nikhil releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Sarah', a friendly and professional Sales Development Rep (SDR) for 'Dr. Nikhil Store'.
